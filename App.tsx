	...
	return (
		<View style={styles.parentContainer}>
			...
			{renderUI && <View style={styles.container}>
				...
				<TextInput placeholder={"Type your status here..."} value={status} placeholderTextColor={"#dee2e6"} style={{flexShrink: 1, color: "#FFF", borderColor: "#FFF", borderWidth: 1, borderRadius: 5, marginBottom: 15, padding: 5}} onChangeText={(text) => { setStatus(text) }}></TextInput>
